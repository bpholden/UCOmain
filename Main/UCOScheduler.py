...
def getNext(ctime, seeing, slowdown, bstar=False,template=False,sheetns=["RECUR_A100",],owner='public',outfn="googledex.dat",toofn="too.dat",outdir=None,focval=0,inst='',rank_sheetn='rank_table',delta_t=0):
