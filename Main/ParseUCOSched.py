...
def update_online_sheets(observed_file, ctime=None, outfn='parsesched.dat', outdir=None, sheetns=None):
    """
    ...
    if sheetns is not None:
        needed_sheetns = [s for s in needed_sheetns if s in sheetns]
